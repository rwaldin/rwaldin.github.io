...
`),i=t.texShape,a=rt(),l=CE(a),c,u,p=IE(a);return t.isPacked?(c=bE(t.logicalShape,i,r.enableShapeUniforms),u=$E(a)):(c=vE(t.logicalShape,i,r.enableShapeUniforms),u=SE(a)),r.packedInputs&&(p+=kE),[p,l,u,n,c,s,r.userCode].join(`
...
`;let o=_e(["r","c","d"],e);return`
  ...
  `}let{newShape:i,keptDims:a}=w.squeezeShape(r),l=i;if(l.length<r.length){let f=Jo(e,l),d=["row","col"];return`
    ...
    `;let c=s[0],u=s[1],p=eo(o);return u===1?t?`
      float ${n}(int row, int col) {
...
`}function qE(e,t){let r=e.shapeInfo.logicalShape,o=e.name,n="get"+o.charAt(0).toUpperCase()+o.slice(1),s=e.shapeInfo.texShape,i=[Math.ceil(s[0]/2),Math.ceil(s[1]/2)];if(r[0]===1){let f=r.slice(1),d=[1,2],h=Jo(e,f),x=["b","row","col"];return`
  ...
  `}function KE(e,t){let r=e.shapeInfo.logicalShape,o=e.name,n="get"+o.charAt(0).toUpperCase()+o.slice(1),s=r[1]*r[2],i=r[2],{newShape:a,keptDims:l}=w.squeezeShape(r),c=a;if(c.length<r.length){let x=Jo(e,c),g=["row","col","depth"];return`
        ${Qo(x,t)}
  ...
  `}function jE(e,t){let r=e.shapeInfo.logicalShape,o=e.name,n="get"+o.charAt(0).toUpperCase()+o.slice(1),s=r[3],i=r[2]*s,a=r[1]*i,{newShape:l,keptDims:c}=w.squeezeShape(r);if(l.length<r.length){let y=Jo(e,l),v=["row","col","depth","depth2"];return`
      ${Qo(y,t)}
  ...
  `}function YE(e){let t=e.shapeInfo.logicalShape,r=e.name,o="get"+r.charAt(0).toUpperCase()+r.slice(1),n=t[4],s=t[3]*n,i=t[2]*s,a=t[1]*i,{newShape:l,keptDims:c}=w.squeezeShape(t);if(l.length<t.length){let x=Jo(e,l),g=["row","col","depth","depth2","depth3"];return`
      ${Qo(x)}
  ...
  `}function ZE(e,t){let r=e.name,o=r.charAt(0).toUpperCase()+r.slice(1),n="get"+o+"AtOutCoords",s=e.shapeInfo.logicalShape.length,i=t.logicalShape.length,a=ox(e.shapeInfo.logicalShape,t.logicalShape),l=G(i),c=i-s,u,p=["x","y","z","w","u","v"];s===0?u="":i<2&&a.length>=1?u="coords = 0;":u=a.map(y=>`coords.${p[y+c]} = 0;`).join(`
`);let f="";i<2&&s>0?f="coords":f=e.shapeInfo.logicalShape.map((y,v)=>`coords.${p[v+c]}`).join(", ");let d="return outputValue;",x=w.sizeFromShape(e.shapeInfo.logicalShape)===1,m=w.sizeFromShape(t.logicalShape)===1;if(s===1&&!x&&!m)d=`
  ...
  `}function JE(e,t){let r=e.name,o=r.charAt(0).toUpperCase()+r.slice(1),n="get"+o+"AtOutCoords",s=t.texShape,i=e.shapeInfo.texShape,a=e.shapeInfo.logicalShape.length,l=t.logicalShape.length;if(!e.shapeInfo.isUniform&&a===l&&e.shapeInfo.flatOffset==null&&w.arraysEqual(i,s))return`
    ...
    `;let c=G(l),u=ox(e.shapeInfo.logicalShape,t.logicalShape),p=l-a,f,d=["x","y","z","w","u","v"];a===0?f="":l<2&&u.length>=1?f="coords = 0;":f=u.map(x=>`coords.${d[x+p]} = 0;`).join(`
...
`,Ge="return x;",iy="return 1.0 / (1.0 + exp(-1.0 * x));";var ly="return x;",cy=`
  vec4 result;
...
`;function __(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{alpha:s}=o,i=r.makeTensorInfo([],"float32",w.createScalarValue(s,"float32")),a=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new we(yp,n.shape,i.shape):new fe(xp,n.shape,i.shape),l=r.runWebGLProgram(a,[n,i],"float32");return r.disposeIntermediateTensorInfo(i),l}var my={kernelName:ri,backendName:"webgl",kernelFunc:__};var wp="return (a < 0.) ? b * a : a;",bp=`
  vec4 aLessThanZero = vec4(lessThan(a, vec4(0.)));
  return (aLessThanZero * (b * a)) + ((vec4(1.0) - aLessThanZero) * a);
`;function k_(e){let{inputs:t,backend:r}=e,{x:o,alpha:n}=t,s=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new we(bp,o.shape,n.shape):new fe(wp,o.shape,n.shape);return r.runWebGLProgram(s,[o,n],"float32")}var gy={kernelName:pi,backendName:"webgl",kernelFunc:k_};var be="if (isnan(x)) return x;";function L({opSnippet:e,packedOpSnippet:t,cpuKernelImpl:r,dtype:o}){return({inputs:n,backend:s})=>{let{x:i}=n,a=s,l=o||i.dtype;if(a.shouldExecuteOnCPU([i])&&r!=null){let p=a.texData.get(i.dataId),f=r(p.values,l);return a.makeTensorInfo(i.shape,l,f)}let c=$().getBool("WEBGL_PACK_UNARY_OPERATIONS")&&t!=null,u;return c?u=new Ht(i.shape,t):u=new Et(i.shape,e),a.runWebGLProgram(u,[i],l)}}function X({opSnippet:e,packedOpSnippet:t,checkOutOfBounds:r=!1,supportsComplex:o=!1,cpuKernelImpl:n,dtype:s}){return({inputs:i,backend:a})=>{let{a:l,b:c}=i,u=a;if(o&&l.dtype==="complex64"){let h=u.texData.get(l.dataId),x=u.texData.get(c.dataId),[g,m]=[[h.complexTensorInfos.real,x.complexTensorInfos.real],[h.complexTensorInfos.imag,x.complexTensorInfos.imag]].map(v=>{let[b,S]=v,I={dataId:b.dataId,dtype:b.dtype,shape:l.shape},T={dataId:S.dataId,dtype:S.dtype,shape:c.shape},E=new fe(e,l.shape,c.shape);return u.runWebGLProgram(E,[I,T],Nt(b.dtype,S.dtype))}),y=qt({inputs:{real:g,imag:m},backend:u});return u.disposeIntermediateTensorInfo(g),u.disposeIntermediateTensorInfo(m),y}let p=s||Nt(l.dtype,c.dtype);if((l.dtype==="string"||c.dtype==="string"||u.shouldExecuteOnCPU([l,c]))&&n!=null){let h=u.texData.get(l.dataId).values,x=u.texData.get(c.dataId).values,g=l.dtype==="string"?C.fromUint8ToStringArray(h):h,m=l.dtype==="string"?C.fromUint8ToStringArray(x):x,[y,v]=n(l.shape,c.shape,g,m,p),b=u.makeTensorInfo(v,p),S=u.texData.get(b.dataId);return S.values=y,b}let f=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")&&t!=null,d;return f?d=new we(t,l.shape,c.shape,r):d=new fe(e,l.shape,c.shape),u.runWebGLProgram(d,[l,c],p)}}function or(e,t=!1){if(e==="linear")return t?ly:ry;if(e==="relu")return t?uy:ny;if(e==="elu")return t?cy:oy;if(e==="relu6")return t?py:sy;if(e==="prelu")return t?bp:wp;if(e==="leakyrelu")return t?yp:xp;if(e==="sigmoid")return t?fy:iy;throw new Error(`Activation ${e} has not been implemented for the WebGL backend.`)}var ln=class{constructor(t,r,o,n=!1,s=!1,i=!1,a=null,l=!1,c=!1){this.variableNames=["matrixA","matrixB"],this.packedInputs=!0,this.packedOutput=!0,this.outputShape=o,this.enableShapeUniforms=j(this.outputShape.length);let u=n?t[1]:t[2],p=Math.ceil(u/2),f=n?"i * 2, rc.y":"rc.y, i * 2",d=s?"rc.z, i * 2":"i * 2, rc.z",h=n?["a.xxyy","a.zzww"]:["a.xxzz","a.yyww"],x=s?["b.xzxz","b.ywyw"]:["b.xyxy","b.zwzw"],g="",m="";a&&(l?g=`vec4 activation(vec4 a) {
    ...
    `}};var xy="return a * b;";function ns(e){let{inputs:t,backend:r}=e,{a:o,b:n}=t,s=C.upcastType(o.dtype,n.dtype);if(o.dtype==="complex64"){let a=r.texData.get(o.dataId),l=r.texData.get(n.dataId),c=new os(vp.REAL,o.shape,n.shape),u=new os(vp.IMAG,o.shape,n.shape),p=[{dataId:a.complexTensorInfos.real.dataId,dtype:a.complexTensorInfos.real.dtype,shape:o.shape},{dataId:a.complexTensorInfos.imag.dataId,dtype:a.complexTensorInfos.imag.dtype,shape:o.shape},{dataId:l.complexTensorInfos.real.dataId,dtype:l.complexTensorInfos.real.dtype,shape:n.shape},{dataId:l.complexTensorInfos.imag.dataId,dtype:l.complexTensorInfos.imag.dtype,shape:n.shape}],f=r.runWebGLProgram(c,p,"float32"),d=r.runWebGLProgram(u,p,"float32"),h=qt({inputs:{real:f,imag:d},backend:r});return r.disposeIntermediateTensorInfo(f),r.disposeIntermediateTensorInfo(d),h}if(r.shouldExecuteOnCPU([o,n])){let a=r.texData.get(o.dataId),l=r.texData.get(n.dataId),[c,u]=_0(o.shape,n.shape,a.values,l.values,s),p=r.makeTensorInfo(u,s),f=r.texData.get(p.dataId);return f.values=c,p}let i;return $().getBool("WEBGL_PACK_BINARY_OPERATIONS")?i=new we(xy,o.shape,n.shape):i=new fe(xy,o.shape,n.shape),r.runWebGLProgram(i,[o,n],s)}var yy={kernelName:Do,backendName:"webgl",kernelFunc:ns};function wy(e,t,r){let o=[Sr(e.shape),...$r(e.shape)],n={dtype:e.dtype,shape:o,dataId:e.dataId},s=[Sr(t),...$r(t)],i=new sn(s,o),a=!0,l=[o],c=r.runWebGLProgram(i,[n],e.dtype,l,a);return{dataId:c.dataId,shape:t,dtype:c.dtype}}function _(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{shape:s}=o,i=r,a=w.sizeFromShape(n.shape),l=w.inferFromImplicitShape(s,a),c=w.sizeFromShape(l);w.assert(a===c,()=>`The new shape (${l}) has ${c} elements and the old shape (${n.shape}) has ${a} elements. The new shape and old shape must have the same number of elements.`);let u=i.texData.get(n.dataId);return u.isPacked&&!Jr(n.shape,l)&&!(u.texture!==null&&Jr(u.shape,l))?wy(n,l,i):(i.incRef(n.dataId),{dataId:n.dataId,shape:l,dtype:n.dtype})}var by={kernelName:di,backendName:"webgl",kernelFunc:_};var ss=class{constructor(t,r){this.variableNames=["x"];let{windowSize:o,batchSize:n,inSize:s,outSize:i}=t;this.outputShape=[n,i];let a=Math.floor(o/4)*4,l=o%4,c="sumValue += dot(values, ones);";if(r!=null){let p=1/r;c=`sumValue += dot(values * ${w.isInt(p)?p.toPrecision(2):p}, ones);`}let u="";s%o>0&&(u=`
        if (inIdx < 0 || inIdx >= ${s}) {
          return 0.0;
        }
      `),this.userCode=`
    ...
    `}};function R_(e){let t=[];for(;t.length===0||t[t.length-1].outSize!==1;){let r=t.length?t[t.length-1].outSize:e[1],o=C.computeOptimalWindowSize(r);t.push({inSize:r,windowSize:o,outSize:Math.ceil(r/o)})}return t}function re(e,t,r,o){let n=R_(e.shape),s=e;for(let i=0;i<n.length;i++){let{inSize:a,windowSize:l,outSize:c}=n[i],u,p;r==="mean"?u=i===0?new ss({windowSize:l,inSize:a,batchSize:e.shape[0],outSize:c},a):new ss({windowSize:l,inSize:a,batchSize:e.shape[0],outSize:c}):u=new ya({windowSize:l,inSize:a,batchSize:e.shape[0],outSize:c},r),p=s,s=o.runWebGLProgram(u,[s],t),p.dataId!==e.dataId&&o.disposeIntermediateTensorInfo(p)}return s}var wa=class{constructor(t,r){this.variableNames=["A"];let o=new Array(t.length);for(let i=0;i<o.length;i++)o[i]=t[r[i]];this.outputShape=o,this.rank=o.length;let n=G(this.rank),s=N_(r);this.userCode=`
    void main() {
      ${n} resRC = getOutputCoords();
      setOutput(getA(${s}));
    }
    `}};function N_(e){let t=e.length;if(t>6)throw Error(`Transpose for rank ${t} is not yet supported`);let r=["resRC.x","resRC.y","resRC.z","resRC.w","resRC.u","resRC.v"],o=new Array(t);for(let n=0;n<e.length;n++)o[e[n]]=r[n];return o.join()}var ba=class{constructor(t,r){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0;let o=new Array(t.length);for(let u=0;u<o.length;u++)o[u]=t[r[u]];if(this.outputShape=o,this.rank=o.length,this.rank>6)throw Error(`Packed transpose for rank ${this.rank} is not yet supported.`);let n=G(this.rank),s=mp("rc",this.rank),i=new Array(this.rank);for(let u=0;u<r.length;u++)i[r[u]]=s[u];let a=`vec2(${i.slice(-2).join()})`,l=`++${s[this.rank-1]} < ${o[this.rank-1]}`,c=`getChannel(getA(${i.join()}), ${a})`;this.userCode=`
    void main() {
      ${n} rc = getOutputCoords();
      vec4 result = vec4(0.);
      result[0] = ${c};
...
return log(x + sqrt(x * x - 1.0));`,L_=L({opSnippet:M_}),_y={kernelName:zf,backendName:"webgl",kernelFunc:L_};var ky="return a + b;",B_=X({opSnippet:ky,packedOpSnippet:ky,supportsComplex:!0,cpuKernelImpl:l0}),Ay={kernelName:gr,backendName:"webgl",kernelFunc:B_};var va=class{constructor(t,r){this.outputShape=[],this.outputShape=t,this.variableNames=r.map((s,i)=>`T${i}`);let o=[];this.variableNames.forEach(s=>{o.push(`float v${s} = get${s}AtOutCoords();`)});let n=this.variableNames.map(s=>`v${s}`).join(" + ");this.userCode=`
    ...
    `}};function Sa(e){let{inputs:t,backend:r}=e,o=t;if(o.length===1)return ct({inputs:{x:o[0]},backend:r});if(o.length>$().get("WEBGL_MAX_TEXTURES_IN_SHADER")){let l=Math.floor(o.length/2),c=Sa({inputs:o.slice(0,l),backend:r}),u=Sa({inputs:o.slice(l),backend:r});return Sa({inputs:[c,u],backend:r})}let n=o.map(l=>l.dtype).reduce((l,c)=>Nt(l,c)),s=o.map(l=>l.shape),a=$().getBool("WEBGL_PACK")?new Ca(o[0].shape,s):new va(o[0].shape,s);return r.runWebGLProgram(a,o,n)}var Ry={kernelName:Wf,backendName:"webgl",kernelFunc:Sa};function U_(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{axis:s,keepDims:i}=o,a=n.shape.length,l=w.parseAxisParam(s,n.shape),c=l,u=C.getAxesPermutation(c,a),p=n;u!=null&&(p=J({inputs:{x:n},backend:r,attrs:{perm:u}}),c=C.getInnerMostAxes(c.length,a)),C.assertAxesAreInnerMostDims("all",c,a);let[f,d]=C.computeOutAndReduceShapes(p.shape,c),h=w.sizeFromShape(d),x=_({inputs:{x:p},backend:r,attrs:{shape:[-1,h]}}),g=re(x,x.dtype,"all",r),m;if(i){let y=C.expandShapeToKeepDim(f,l);m=_({inputs:{x:g},backend:r,attrs:{shape:y}})}else m=_({inputs:{x:g},backend:r,attrs:{shape:f}});return r.disposeIntermediateTensorInfo(x),r.disposeIntermediateTensorInfo(g),u!=null&&r.disposeIntermediateTensorInfo(p),m}var Ny={kernelName:Gf,backendName:"webgl",kernelFunc:U_};function V_(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{axis:s,keepDims:i}=o,a=n.shape.length,l=w.parseAxisParam(s,n.shape),c=l,u=C.getAxesPermutation(c,a),p=n;u!=null&&(p=J({inputs:{x:n},backend:r,attrs:{perm:u}}),c=C.getInnerMostAxes(c.length,a)),C.assertAxesAreInnerMostDims("any",c,a);let[f,d]=C.computeOutAndReduceShapes(p.shape,c),h=w.sizeFromShape(d),x=_({inputs:{x:p},backend:r,attrs:{shape:[-1,h]}}),g=re(x,x.dtype,"any",r),m;if(i){let y=C.expandShapeToKeepDim(f,l);m=_({inputs:{x:g},backend:r,attrs:{shape:y}})}else m=_({inputs:{x:g},backend:r,attrs:{shape:f}});return r.disposeIntermediateTensorInfo(x),r.disposeIntermediateTensorInfo(g),u!=null&&r.disposeIntermediateTensorInfo(p),m}var Fy={kernelName:Hf,backendName:"webgl",kernelFunc:V_};var $a=class{constructor(t,r,o){this.variableNames=["A"];let{windowSize:n,batchSize:s,outSize:i}=t;o||this.variableNames.push("bestIndicesA"),this.outputShape=[s,i];let a=r==="max"?">":"<",l=o?"inOffset + i;":"round(getBestIndicesA(batch, inOffset + i));";this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
        int batch = coords[0];
        int outIdx = coords[1];
    ...
    `}};function Dy(e,t,r,o=null){let n=t.shape[0],s=t.shape[1];o!=null&&(n=o.shape[0],s=o.shape[1]);let i=C.computeOptimalWindowSize(s),a={windowSize:i,inSize:s,batchSize:n,outSize:Math.ceil(s/i)},l=new $a(a,r,o==null),c=[t];o!=null&&c.push(o);let u=e.runWebGLProgram(l,c,"int32");if(u.shape[1]===1)return u;let p=Dy(e,t,r,u);return e.disposeIntermediateTensorInfo(u),p}function Oy(e,t,r,o=null){let n=o!=null?o.shape:t.shape,s=n[n.length-1],i=C.computeOptimalWindowSize(s),a=new Ia(n,i,r,o==null),l=o==null?[t]:[t,o],c=e.runWebGLProgram(a,l,"int32");if(c.shape.length===t.shape.length){let u=Oy(e,t,r,c);return e.disposeIntermediateTensorInfo(c),u}return c}function Ta(e,t,r,o){let n=[r];if(C.assertAxesAreInnerMostDims("arg"+o.charAt(0).toUpperCase()+o.slice(1),n,t.shape.length),!$().getBool("WEBGL_PACK_REDUCE")||t.shape.length<=2){let s=[],i=e.texData.get(t.dataId),a=i!==null&&i.isPacked,l=t;a&&(l=e.unpackTensor(t),s.push(l));let[c,u]=C.computeOutAndReduceShapes(l.shape,n),p=w.sizeFromShape(u),f=_({inputs:{x:l},backend:e,attrs:{shape:[-1,p]}});s.push(f);let d=Dy(e,f,o);s.push(d);let h=_({inputs:{x:d},backend:e,attrs:{shape:c}});return s.forEach(x=>e.disposeIntermediateTensorInfo(x)),h}return Oy(e,t,o)}function z_(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{axis:s}=o,i=w.parseAxisParam(s,n.shape),a=C.getAxesPermutation(i,n.shape.length),l=n,c=[];a!=null&&(l=J({inputs:{x:n},backend:r,attrs:{perm:a}}),c.push(l),i=C.getInnerMostAxes(i.length,l.shape.length)),C.assertAxesAreInnerMostDims("argMax",[i[0]],l.shape.length);let u=Ta(r,l,i[0],"max");return c.forEach(p=>r.disposeIntermediateTensorInfo(p)),u}var Py={kernelName:qf,backendName:"webgl",kernelFunc:z_};function W_(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{axis:s}=o,i=w.parseAxisParam(s,n.shape),a=C.getAxesPermutation(i,n.shape.length),l=n,c=[];a!=null&&(l=J({inputs:{x:n},backend:r,attrs:{perm:a}}),c.push(l),i=C.getInnerMostAxes(i.length,l.shape.length)),C.assertAxesAreInnerMostDims("argMin",[i[0]],l.shape.length);let u=Ta(r,l,i[0],"min");return c.forEach(p=>r.disposeIntermediateTensorInfo(p)),u}var My={kernelName:Kf,backendName:"webgl",kernelFunc:W_};var G_=dt+`
  if (abs(x) > 1.) {
    return NAN;
  }
  return asin(x);
...
return (log(1.0 + x) - log(1.0 - x)) / 2.0;`,tk=L({opSnippet:J_}),zy={kernelName:Qf,backendName:"webgl",kernelFunc:tk};var ke=class{constructor(t,r,o,n=!1,s=!1){if(this.variableNames=["x"],r==="avg"&&o)throw new Error("Cannot compute positions for average pool.");let i=t.filterWidth,a=t.strideHeight,l=t.strideWidth,c=t.dilationHeight,u=t.dilationWidth,p=t.effectiveFilterHeight,f=t.effectiveFilterWidth,d=t.padInfo.top,h=t.padInfo.left;this.outputShape=t.outShape;let x=r==="avg",g=`((batch  * ${t.inHeight} + xR) * ${t.inWidth} + xC) * ${t.inChannels} + d`,m=`(xR * ${t.inWidth} + xC) * ${t.inChannels} + d`,y="0.0";if(x||(y="-1.0 / 1e-20"),o){let E=">=";this.userCode=`
    ...
    `}},Tr=class{constructor(t,r,o,n=!1,s=!1){if(this.variableNames=["x"],r==="avg"&&o)throw new Error("Cannot compute positions for average pool.");let i=t.filterWidth,a=t.strideDepth,l=t.strideHeight,c=t.strideWidth,u=t.dilationDepth,p=t.dilationHeight,f=t.dilationWidth,d=t.effectiveFilterDepth,h=t.effectiveFilterHeight,x=t.effectiveFilterWidth,g=t.padInfo.front,m=t.padInfo.top,y=t.padInfo.left;this.outputShape=t.outShape;let v=r==="avg",b="0.0";if(v||(b="-1.0 / 1e-20"),o){let F=">=";this.userCode=`
        const ivec3 strides =
            ivec3(${a}, ${l}, ${c});
...
`);this.userCode=`
    ...
    `}};function lk(e,t,r,o){let n=o.texData.get(e.dataId),s=o.makeTensorInfo(r,e.dtype),i=o.texData.get(s.dataId);Object.assign(i,n),i.refCount=1,i.shape=r,i.dtype=e.dtype;let a=Wt.computeFlatOffset(t,w.computeStrides(e.shape));n.slice&&(a+=n.slice.flatOffset),i.slice={flatOffset:a,origDataId:n.slice&&n.slice.origDataId||e.dataId};let l=o.dataRefCount.get(i.slice.origDataId)||1;return o.dataRefCount.set(i.slice.origDataId,l+1),s}function Ae(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{begin:s,size:i}=o,[a,l]=Wt.parseSliceParams(n,s,i);if(Wt.assertParamsValid(n,a,l),w.sizeFromShape(l)===0)return r.makeTensorInfo(l,n.dtype,[]);if(r.shouldExecuteOnCPU([n])||n.dtype==="string"){let p=r.texData.get(n.dataId),f=B0(p.values,a,l,n.shape,n.dtype);return r.makeTensorInfo(l,n.dtype,f)}let{isPacked:c}=r.texData.get(n.dataId),u=Wt.isSliceContinous(n.shape,a,l);if(c||!u){let p=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new Na(l):new Ra(l),f=[a];return r.runWebGLProgram(p,[n],n.dtype,f)}return r.uploadToGPU(n.dataId),lk(n,a,l,r)}var jy={kernelName:Vc,backendName:"webgl",kernelFunc:Ae};var ck=e=>{let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{blockShape:s,crops:i}=o;w.assert(n.shape.length<=4,()=>"batchToSpaceND for rank > 4 with a WebGL backend not implemented yet");let a=s.reduce((y,v)=>y*v),l=C.getReshaped(n.shape,s,a),c=C.getPermuted(l.length,s.length),u=C.getReshapedPermuted(n.shape,s,a),p=C.getSliceBeginCoords(i,s.length),f=C.getSliceSize(u,i,s.length),d=[],h=_({inputs:{x:n},backend:r,attrs:{shape:l}}),x=J({inputs:{x:h},backend:r,attrs:{perm:c}}),g=_({inputs:{x},backend:r,attrs:{shape:u}}),m=Ae({inputs:{x:g},backend:r,attrs:{begin:p,size:f}});return d.push(h),d.push(x),d.push(g),d.forEach(y=>r.disposeIntermediateTensorInfo(y)),m},Yy={kernelName:od,backendName:"webgl",kernelFunc:ck};function uk(e){let{inputs:t,backend:r,attrs:o}=e,{x:n,weights:s}=t,{size:i}=o,a=r.readSync(n.dataId),l=r.readSync(s.dataId),c=pa(a,l,s.dtype,s.shape,i);return r.makeTensorInfo([i],s.dtype,c)}var Qy={kernelName:nd,backendName:"webgl",kernelFunc:uk};function pk(e){let{inputs:t,backend:r}=e,{s0:o,s1:n}=t,s=r.readSync(o.dataId),i=r.readSync(n.dataId),a=C.assertAndGetBroadcastShape(Array.from(s),Array.from(i));return r.makeTensorInfo([a.length],"int32",Int32Array.from(a))}var Zy={kernelName:sd,backendName:"webgl",kernelFunc:pk};var fk="return float(a != b);",$p=X({opSnippet:fk,cpuKernelImpl:A0,dtype:"bool"}),Jy={kernelName:ci,backendName:"webgl",kernelFunc:$p};function nr(e){let{inputs:t,backend:r}=e,{input:o}=t,n=r.texData.get(o.dataId);return ct({inputs:{x:n.complexTensorInfos.real},backend:r})}var tw={kernelName:On,backendName:"webgl",kernelFunc:nr};var dk="return float(int(x));";function ew(e,t){let r=new Et(e.shape,dk),o=t.runWebGLProgram(r,[e],"int32");return{dataId:o.dataId,shape:o.shape,dtype:o.dtype}}function Ip(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{dtype:s}=o;if(s==="complex64"){if(n.dtype==="complex64")return ct({inputs:{x:n},backend:r});let i=Hn(n.shape),a=Ip({inputs:{x:n},backend:r,attrs:{dtype:"float32"}}),l=qt({inputs:{real:a,imag:i},backend:r});return i.dispose(),r.disposeIntermediateTensorInfo(a),l}if(n.dtype==="complex64"){let i=nr({inputs:{input:n},backend:r}),a=Ip({inputs:{x:i},backend:r,attrs:{dtype:s}});return r.disposeIntermediateTensorInfo(i),a}if(!w.hasEncodingLoss(n.dtype,s)){let i=ct({inputs:{x:n},backend:r});return{dataId:i.dataId,shape:i.shape,dtype:s}}if(r.shouldExecuteOnCPU([n])){let i=r.texData.get(n.dataId).values,[a,l,c]=u0(i,n.shape,n.dtype,s);return r.makeTensorInfo(a,l,c)}if(s==="int32")return ew(n,r);if(s==="bool"){let i=r.makeTensorInfo([],"bool",w.getTypedArrayFromDType("bool",1)),l=$p({inputs:{a:n,b:i},backend:r});return r.disposeIntermediateTensorInfo(i),l}throw new Error(`Error in Cast: failed to cast ${n.dtype} to ${s}`)}var rw={kernelName:Vr,backendName:"webgl",kernelFunc:Ip};var ow="return ceil(x);",hk=L({opSnippet:ow,packedOpSnippet:ow,cpuKernelImpl:p0}),nw={kernelName:Gs,backendName:"webgl",kernelFunc:hk};var Fa=class{constructor(t){this.variableNames=["A"],this.customUniforms=[{name:"minVal",type:"float"},{name:"maxVal",type:"float"}],this.outputShape=t,this.userCode=`
   ...
   `;let d="",h="";o&&(n?d=`vec4 activation(vec4 a) {
    ...
    `}},Ha=class{constructor(t){this.variableNames=["dy","W"],this.outputShape=t.inShape;let r=t.filterHeight,o=t.filterWidth,n=t.strideHeight,s=t.strideWidth,i=t.dataFormat==="channelsLast",a=r-1-t.padInfo.top,l=o-1-t.padInfo.left,c=i?1:2,u=i?2:3,p=i?3:1;this.userCode=`
    ...
    `}},Ka=class{constructor(t){this.variableNames=["dy","W"],this.outputShape=t.inShape;let r=t.filterDepth,o=t.filterHeight,n=t.filterWidth,s=t.strideDepth,i=t.strideHeight,a=t.strideWidth,l=r-1-t.padInfo.front,c=o-1-t.padInfo.top,u=n-1-t.padInfo.left;this.userCode=`
    ...
    `}};function wk(e){let{inputs:t,backend:r,attrs:o}=e,{x:n,dy:s}=t,{strides:i,pad:a,dataFormat:l,dimRoundingMode:c,filterShape:u}=o,p=C.convertConv2DDataFormat(l),f=C.computeConv2DInfo(n.shape,u,i,1,a,c,!1,p),d=new Ga(f);return r.runWebGLProgram(d,[n,s],"float32")}var pw={kernelName:cd,backendName:"webgl",kernelFunc:wk};var Xa=class{constructor(t){this.variableNames=["dy","W"],this.packedInputs=!0,this.packedOutput=!0,this.customUniforms=[{name:"strides",type:"vec2"}],this.outputShape=t.inShape,this.enableShapeUniforms=j(this.outputShape.length);let r=t.filterHeight,o=t.filterWidth,n=r-1-t.padInfo.top,s=o-1-t.padInfo.left;this.userCode=`
    ...
    `}};function bk(e){let{inputs:t,backend:r,attrs:o}=e,{dy:n,filter:s}=t,{inputShape:i,strides:a,pad:l,dataFormat:c,dimRoundingMode:u}=o,p=C.convertConv2DDataFormat(c),f=C.computeConv2DInfo(i,s.shape,a,1,l,u,!1,p);if($().getBool("WEBGL_PACK")&&p==="channelsLast"){let d=[[f.strideHeight,f.strideWidth]],h=new Xa(f);return r.runWebGLProgram(h,[n,s],"float32",d)}else{let d=new Ha(f);return r.runWebGLProgram(d,[n,s],"float32")}}var fw={kernelName:ud,backendName:"webgl",kernelFunc:bk};function vk(e){let{inputs:t,backend:r,attrs:o}=e,{x:n,filter:s}=t,{strides:i,pad:a,dilations:l}=o,c=C.computeConv3DInfo(n.shape,s.shape,i,l,a),u=new Ba(c);return r.runWebGLProgram(u,[n,s],"float32")}var dw={kernelName:pd,backendName:"webgl",kernelFunc:vk};function Ck(e){let{inputs:t,backend:r,attrs:o}=e,{x:n,dy:s}=t,{strides:i,pad:a,filterShape:l}=o,c=C.computeConv3DInfo(n.shape,l,i,1,a),u=new qa(c);return r.runWebGLProgram(u,[n,s],"float32")}var hw={kernelName:fd,backendName:"webgl",kernelFunc:Ck};function Sk(e){let{inputs:t,backend:r,attrs:o}=e,{dy:n,filter:s}=t,{pad:i,strides:a,inputShape:l}=o,c=C.computeConv3DInfo(l,s.shape,a,1,i),u=new Ka(c);return r.runWebGLProgram(u,[n,s],"float32")}var mw={kernelName:dd,backendName:"webgl",kernelFunc:Sk};var $k=be+`
  return cos(x);
`,Ik=`
  vec4 result = cos(x);
  bvec4 isNaN = isnan(x);
...
`,_k=L({opSnippet:Ek}),xw={kernelName:md,backendName:"webgl",kernelFunc:_k};var ja=class{constructor(t,r,o,n,s){this.variableNames=["Image","Boxes","BoxInd"],this.outputShape=[];let[i,a,l,c]=t,[u]=r,[p,f]=o;this.outputShape=[u,p,f,c];let d=n==="bilinear"?1:0,[h,x]=[`${a-1}.0`,`${l-1}.0`],[g,m,y]=p>1?[`${(a-1)/(p-1)}`,"(y2-y1) * height_ratio",`y1*${h} + float(y)*(height_scale)`]:["0.0","0.0",`0.5 * (y1+y2) * ${h}`],[v,b,S]=f>1?[`${(l-1)/(f-1)}`,"(x2-x1) * width_ratio",`x1*${x} + float(x)*(width_scale)`]:["0.0","0.0",`0.5 * (x1+x2) * ${x}`];this.userCode=`
  ...
  `,d+=`
    ...
    `}};function Ok(e){let{inputs:t,backend:r,attrs:o}=e,{x:n,dy:s}=t,{strides:i,dilations:a,pad:l,dimRoundingMode:c,filterShape:u}=o,p=C.computeConv2DInfo(n.shape,u,i,a,l,c,!0),f=new Za(p);return r.runWebGLProgram(f,[n,s],"float32")}var Tw={kernelName:Cd,backendName:"webgl",kernelFunc:Ok};function Pk(e){let{inputs:t,backend:r,attrs:o}=e,{dy:n,filter:s}=t,{strides:i,dilations:a,pad:l,dimRoundingMode:c,inputShape:u}=o,p=C.computeConv2DInfo(u,s.shape,i,a,l,c,!0),f=new Ja(p);return r.runWebGLProgram(f,[n,s],"float32")}var Ew={kernelName:Sd,backendName:"webgl",kernelFunc:Pk};var tl=class{constructor(t){this.variableNames=["X"],this.outputShape=[t,t],this.userCode=`
      void main() {
          ivec2 coords = getOutputCoords();
          float val = coords[0] == coords[1] ? getX(coords[0]) : 0.0;
          setOutput(val);
      }
    `}};function Mk(e){let{inputs:t,backend:r}=e,{x:o}=t,n=[...o.shape,...o.shape],s=w.sizeFromShape(o.shape),i=_({inputs:{x:o},backend:r,attrs:{shape:[s]}}),a=new tl(s),l=r.runWebGLProgram(a,[i],i.dtype),c=_({inputs:{x:l},backend:r,attrs:{shape:n}});return r.disposeIntermediateTensorInfo(i),r.disposeIntermediateTensorInfo(l),c}var _w={kernelName:$d,backendName:"webgl",kernelFunc:Mk};var el=class{constructor(t){this.variableNames=["x","W"],this.outputShape=t.outShape;let{inHeight:r,inWidth:o,padInfo:n,strideHeight:s,strideWidth:i,filterHeight:a,filterWidth:l,dilationHeight:c,dilationWidth:u}=t,{top:p,left:f}=n;this.userCode=`
...
`,Ep=L({opSnippet:Qk,packedOpSnippet:Zk,cpuKernelImpl:h0,dtype:"float32"}),Ow={kernelName:js,backendName:"webgl",kernelFunc:Ep};function rl(e){let{inputs:t,attrs:r,backend:o}=e,{dim:n}=r,{input:s}=t,i=s.shape.length,a=s.shape.slice(),l=n;return n<0&&(w.assert(-(i+1)<=n,()=>`Axis must be in the interval [${-(i+1)}, ${i}]`),l=i+n+1),a.splice(l,0,1),_({inputs:{x:s},backend:o,attrs:{shape:a}})}var Pw={kernelName:kd,backendName:"webgl",kernelFunc:rl};var Mw="return exp(x) - 1.0;",Jk=L({opSnippet:Mw,packedOpSnippet:Mw,cpuKernelImpl:m0}),Lw={kernelName:Ys,backendName:"webgl",kernelFunc:Jk};var as=class{constructor(t,r,o){this.variableNames=["real","imag"];let n=r[1];this.outputShape=r;let s=o?`2.0 * ${Math.PI}`:`-2.0 * ${Math.PI}`,i=o?`${n}.0`:"1.0",a;if(t==="real")a="return real * expR - imag * expI;";else if(t==="imag")a="return real * expI + imag * expR;";else throw new Error(`FFT component must be either "real" or "imag", got ${t}.`);this.userCode=`
    ...
    `}};function ol(e,t,r){let o=r.texData.get(e.dataId),n=w.sizeFromShape(e.shape),s=e.shape[e.shape.length-1],i=n/s,a=_({inputs:{x:e},backend:r,attrs:{shape:[i,s]}}),l=a.shape,c=new as("real",l,t),u=new as("imag",l,t),p=[{dataId:o.complexTensorInfos.real.dataId,dtype:o.complexTensorInfos.real.dtype,shape:l},{dataId:o.complexTensorInfos.imag.dataId,dtype:o.complexTensorInfos.imag.dtype,shape:l}],f=r.runWebGLProgram(c,p,"float32"),d=r.runWebGLProgram(u,p,"float32"),h=qt({inputs:{real:f,imag:d},backend:r});r.disposeIntermediateTensorInfo(f),r.disposeIntermediateTensorInfo(d);let x=_({inputs:{x:h},backend:r,attrs:{shape:e.shape}});return r.disposeIntermediateTensorInfo(a),r.disposeIntermediateTensorInfo(h),x}function tA(e){let{inputs:t,backend:r}=e,{input:o}=t;return ol(o,!1,r)}var Bw={kernelName:Ad,backendName:"webgl",kernelFunc:tA};var nl=class{constructor(t,r){this.outputShape=[],this.customUniforms=[{name:"value",type:"float"}],this.variableNames=["x"],this.outputShape=t,this.userCode=`
      void main() {
...
`,MA=X({opSnippet:OA,packedOpSnippet:PA,dtype:"bool"}),ab={kernelName:Vd,backendName:"webgl",kernelFunc:MA};var LA="return float(!(x >= 1.0));",BA=L({opSnippet:LA}),lb={kernelName:zd,backendName:"webgl",kernelFunc:BA};var UA="return float(a >= 1.0 || b >= 1.0);",VA=`
  return min(
    ...
    vec4(greaterThanEqual(b, vec4(1.0))),
    vec4(1.0));
`,zA=X({opSnippet:UA,packedOpSnippet:VA,dtype:"bool"}),cb={kernelName:Wd,backendName:"webgl",kernelFunc:zA};var ul=class{constructor(t,r,o,n,s){this.variableNames=["x"],this.outputShape=[];let i=r,a=t[3]-1;this.outputShape=t;let l,c=`float(${o}) + float(${n}) * sum`;s===.5?l=`inversesqrt(${c})`:s===1?l=`1.0/(${c})`:l=`exp(log(${c}) * float(-${s}));`,this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int r = coords[1];
    ...
    `}};var pl=class{constructor(t,r,o,n,s){this.variableNames=["x"],this.outputShape=[],this.packedInputs=!0,this.packedOutput=!0;let i=r,a=t[3]-1;this.outputShape=t;let l,c=`float(${o}) + float(${n}) * sum`;s===.5?l=`inversesqrt(${c})`:s===1?l=`1.0/(${c})`:l=`exp(log(${c}) * float(-${s}));`,this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords.x;
        int r = coords.y;
    ...
    `}};var WA=e=>{let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{depthRadius:s,bias:i,alpha:a,beta:l}=o,c=$().getBool("WEBGL_PACK_NORMALIZATION")?new pl(n.shape,s,i,a,l):new ul(n.shape,s,i,a,l);return r.runWebGLProgram(c,[n],n.dtype)},ub={kernelName:Gd,backendName:"webgl",kernelFunc:WA};var fl=class{constructor(t,r,o,n,s){this.variableNames=["inputImage","outputImage","dy"],this.outputShape=[],this.outputShape=t,this.depth=t[3],this.depthRadius=r,this.bias=o,this.alpha=n,this.beta=s,this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int r = coords[1];
    ...
    `}};var GA=e=>{let{inputs:t,backend:r,attrs:o}=e,{x:n,y:s,dy:i}=t,{depthRadius:a,bias:l,alpha:c,beta:u}=o,p=new fl(n.shape,a,l,c,u);return r.runWebGLProgram(p,[n,s,i],n.dtype)},pb={kernelName:Hd,backendName:"webgl",kernelFunc:GA};function fb(e,t,r,o){let n=w.sizeFromShape(t),i=w.sizeFromShape(e.shape)/n,a=_({inputs:{x:e},attrs:{shape:[i,n]},backend:o}),l=re(a,e.dtype,"max",o),c=_({inputs:{x:l},attrs:{shape:r},backend:o});return o.disposeIntermediateTensorInfo(a),o.disposeIntermediateTensorInfo(l),c}function Ap(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{reductionIndices:s,keepDims:i}=o,a=n.shape.length,l=w.parseAxisParam(s,n.shape),c=l,u=C.getAxesPermutation(c,a),p=u!=null,f=r.shouldExecuteOnCPU([n]),d=n;if(p){if(f){let v=r.texData.get(d.dataId).values,b=new Array(a);for(let T=0;T<b.length;T++)b[T]=n.shape[u[T]];let S=ro(v,n.shape,n.dtype,u,b);d=r.makeTensorInfo(b,n.dtype);let I=r.texData.get(d.dataId);I.values=S}else d=Ir(n,u,r);c=C.getInnerMostAxes(c.length,a)}C.assertAxesAreInnerMostDims("max",c,a);let[h,x]=C.computeOutAndReduceShapes(d.shape,c),g=h;i&&(g=C.expandShapeToKeepDim(h,l));let m;if(f){let v=r.texData.get(d.dataId).values,b=I0(v,w.sizeFromShape(x),g,n.dtype);m=r.makeTensorInfo(g,n.dtype);let S=r.texData.get(m.dataId);S.values=b}else m=fb(d,x,g,r);return p&&r.disposeIntermediateTensorInfo(d),m}var db={kernelName:ii,backendName:"webgl",kernelFunc:Ap};var HA=an+`
  return max(a, b);
`,qA=`
...
`,KA=X({opSnippet:HA,packedOpSnippet:qA,cpuKernelImpl:T0}),hb={kernelName:Fo,backendName:"webgl",kernelFunc:KA};function XA(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t;We(n,"maxPool");let{filterSize:s,strides:i,pad:a,dimRoundingMode:l}=o,c=1;w.assert(C.eitherStridesOrDilationsAreOne(i,c),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${i} and dilations '${c}'`);let u=C.computePool2DInfo(n.shape,s,i,c,a,l);if(u.filterWidth===1&&u.filterHeight===1&&w.arraysEqual(u.inShape,u.outShape))return ct({inputs:{x:n},backend:r});let p=new ke(u,"max",!1);return r.runWebGLProgram(p,[n],n.dtype)}var mb={kernelName:qd,backendName:"webgl",kernelFunc:XA};function jA(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{filterSize:s,strides:i,pad:a,dataFormat:l,dimRoundingMode:c}=o,u=[1,1,1],p=C.computePool3DInfo(n.shape,s,i,u,a,c,l),f=new Tr(p,"max",!1);return r.runWebGLProgram(f,[n],n.dtype)}var gb={kernelName:Xd,backendName:"webgl",kernelFunc:jA};var dl=class{constructor(t){this.variableNames=["dy","maxPos"],this.outputShape=t.inShape;let r=t.strideHeight,o=t.strideWidth,n=t.dilationHeight,s=t.effectiveFilterHeight,i=t.effectiveFilterWidth,a=s-1-t.padInfo.top,l=i-1-t.padInfo.left,c=s*i-1;this.userCode=`
    ...
    `}};function YA(e){let{inputs:t,backend:r,attrs:o}=e,{dy:n,input:s}=t,i=s,{filterSize:a,strides:l,pad:c,dimRoundingMode:u}=o,p=[1,1,1],f=C.computePool3DInfo(i.shape,a,l,p,c,u),d=new Tr(f,"max",!0),h=r.runWebGLProgram(d,[i],i.dtype),x=new hl(f),g=r.runWebGLProgram(x,[n,h],i.dtype);return r.disposeIntermediateTensorInfo(h),g}var xb={kernelName:jd,backendName:"webgl",kernelFunc:YA};function QA(e){let{inputs:t,backend:r,attrs:o}=e,{dy:n,input:s,output:i}=t,a=s;We([s,i],"maxPoolGrad");let{filterSize:l,strides:c,pad:u,dimRoundingMode:p}=o,f=C.computePool2DInfo(a.shape,l,c,1,u,p),d=!0,h=new ke(f,"max",d),x=r.runWebGLProgram(h,[a],a.dtype),g=new dl(f),m=r.runWebGLProgram(g,[n,x],a.dtype);return r.disposeIntermediateTensorInfo(x),m}var yb={kernelName:Kd,backendName:"webgl",kernelFunc:QA};function wb(e,t,r,o){let n=new ke(r,"max",!1),s=o.runWebGLProgram(n,[e],"float32");n=new ke(r,"max",!0,!0,t);let i=o.runWebGLProgram(n,[e],"float32");return[s,i]}var bb={kernelName:Yd,backendName:"webgl",kernelFunc:({inputs:e,attrs:t,backend:r})=>{let{x:o}=e,{filterSize:n,strides:s,pad:i,includeBatchInIndex:a}=t,l=r;w.assert(o.shape.length===4,()=>`Error in maxPool: input must be rank 4 but got rank ${o.shape.length}.`);let c=[1,1];w.assert(C.eitherStridesOrDilationsAreOne(s,c),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${s} and dilations '${c}'`);let u=C.computePool2DInfo(o.shape,n,s,c,i),[p,f]=wb(o,a,u,l);return[p,f]}};function vb(e,t,r,o){let n=w.sizeFromShape(t),i=w.sizeFromShape(e.shape)/n,a=_({inputs:{x:e},attrs:{shape:[i,n]},backend:o}),l=re(a,"float32","mean",o),c=_({inputs:{x:l},attrs:{shape:r},backend:o});return o.disposeIntermediateTensorInfo(a),o.disposeIntermediateTensorInfo(l),c}var Cb={kernelName:Qd,backendName:"webgl",kernelFunc:({inputs:e,attrs:t,backend:r})=>{let{x:o}=e,{keepDims:n,axis:s}=t,i=r,a=o.shape.length,l=w.parseAxisParam(s,o.shape),c=l,u=C.getAxesPermutation(c,a),p=u!=null,f=i.shouldExecuteOnCPU([o]),d=[],h=o;if(p){if(f){let b=i.texData.get(h.dataId).values,S=new Array(a);for(let E=0;E<S.length;E++)S[E]=o.shape[u[E]];let I=ro(b,o.shape,o.dtype,u,S);h=i.makeTensorInfo(S,o.dtype);let T=i.texData.get(h.dataId);T.values=I}else h=Ir(o,u,i);d.push(h),c=C.getInnerMostAxes(c.length,a)}C.assertAxesAreInnerMostDims("sum",c,a);let[x,g]=C.computeOutAndReduceShapes(h.shape,c),m=x;n&&(m=C.expandShapeToKeepDim(x,l));let y=vb(h,g,m,i);for(let v of d)i.disposeIntermediateTensorInfo(v);return y}};function ZA(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{axis:s,keepDims:i}=o,a=n.shape.length,l=w.parseAxisParam(s,n.shape),c=l,u=C.getAxesPermutation(c,a),p=n;u!=null&&(p=J({inputs:{x:n},backend:r,attrs:{perm:u}}),c=C.getInnerMostAxes(c.length,n.shape.length)),C.assertAxesAreInnerMostDims("min",c,a);let[f,d]=C.computeOutAndReduceShapes(p.shape,c),h=w.sizeFromShape(d),x=_({inputs:{x:p},backend:r,attrs:{shape:[-1,h]}}),g=re(x,x.dtype,"min",r),m;if(i){let y=C.expandShapeToKeepDim(f,l);m=_({inputs:{x:g},backend:r,attrs:{shape:y}})}else m=_({inputs:{x:g},backend:r,attrs:{shape:f}});return r.disposeIntermediateTensorInfo(x),r.disposeIntermediateTensorInfo(g),u!=null&&r.disposeIntermediateTensorInfo(p),m}var Sb={kernelName:ai,backendName:"webgl",kernelFunc:ZA};var JA=an+`
  return min(a, b);
`,tR=`
...
`,uR=`
  ...
  return result;
`;function pR(e){let{inputs:t,backend:r}=e,{x:o}=t;if(r.shouldExecuteOnCPU([o])){let s=r.texData.get(o.dataId),[i,a]=k0(s.values,o.shape,o.dtype);return r.makeTensorInfo(a,o.dtype,i)}let n;return $().getBool("WEBGL_PACK_UNARY_OPERATIONS")?n=new Ht(o.shape,uR):n=new Et(o.shape,cR),r.runWebGLProgram(n,[o],o.dtype)}var Nb={kernelName:Dn,backendName:"webgl",kernelFunc:pR};var fR=Ve.nonMaxSuppressionV3Impl;function dR(e){C.warn("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");let{inputs:t,backend:r,attrs:o}=e,{boxes:n,scores:s}=t,{maxOutputSize:i,iouThreshold:a,scoreThreshold:l}=o,c=r.readSync(n.dataId),u=r.readSync(s.dataId),{selectedIndices:p}=fR(c,u,i,a,l);return r.makeTensorInfo([p.length],"int32",new Int32Array(p))}var Fb={kernelName:eh,backendName:"webgl",kernelFunc:dR};var hR=Ve.nonMaxSuppressionV4Impl;function mR(e){C.warn("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");let{inputs:t,backend:r,attrs:o}=e,{boxes:n,scores:s}=t,{maxOutputSize:i,iouThreshold:a,scoreThreshold:l,padToMaxOutputSize:c}=o,u=r.readSync(n.dataId),p=r.readSync(s.dataId),{selectedIndices:f,validOutputs:d}=hR(u,p,i,a,l,c);return[r.makeTensorInfo([f.length],"int32",new Int32Array(f)),r.makeTensorInfo([],"int32",new Int32Array([d]))]}var Db={kernelName:rh,backendName:"webgl",kernelFunc:mR};var gR=Ve.nonMaxSuppressionV5Impl;function xR(e){C.warn("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");let{inputs:t,backend:r,attrs:o}=e,{boxes:n,scores:s}=t,{maxOutputSize:i,iouThreshold:a,scoreThreshold:l,softNmsSigma:c}=o,u=r.readSync(n.dataId),p=r.readSync(s.dataId),f=i,d=a,h=l,x=c,{selectedIndices:g,selectedScores:m}=gR(u,p,f,d,h,x);return[r.makeTensorInfo([g.length],"int32",new Int32Array(g)),r.makeTensorInfo([m.length],"float32",new Float32Array(m))]}var Ob={kernelName:oh,backendName:"webgl",kernelFunc:xR};var yl=class{constructor(t,r,o,n){this.variableNames=["indices"],this.outputShape=[t,r],this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
...
`,vR=`
  ...
  `+ee+`
  return result;
`,CR=X({opSnippet:bR,packedOpSnippet:vR}),zb={kernelName:ui,backendName:"webgl",kernelFunc:CR};function SR(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{axis:s,keepDims:i}=o,a=n.shape.length,l=[],c=w.parseAxisParam(s,n.shape),u=c,p=C.getAxesPermutation(u,a),f=n;p!=null&&(f=J({inputs:{x:n},backend:r,attrs:{perm:p}}),u=C.getInnerMostAxes(u.length,a),l.push(f)),C.assertAxesAreInnerMostDims("prod",u,a);let d;if(r.shouldExecuteOnCPU([f])){let h=r.texData.get(f.dataId).values,{outVals:x,outShape:g,outDtype:m}=R0(f.shape,f.dtype,h,u);d=r.makeTensorInfo(g,m,x)}else{let[h,x]=C.computeOutAndReduceShapes(f.shape,u),g=w.sizeFromShape(x),m=_({inputs:{x:f},backend:r,attrs:{shape:[-1,g]}}),y=Xr(n.dtype),v=re(m,y,"prod",r);d=_({inputs:{x:v},backend:r,attrs:{shape:h}}),l.push(m),l.push(v)}if(i){l.push(d);let h=C.expandShapeToKeepDim(d.shape,c);d=_({inputs:{x:d},backend:r,attrs:{shape:h}})}return l.forEach(h=>r.disposeIntermediateTensorInfo(h)),d}var Wb={kernelName:Uc,backendName:"webgl",kernelFunc:SR};function $R(e){let{inputs:t,backend:r,attrs:o}=e,{paramsNestedSplits:n,paramsDenseValues:s,indices:i}=t,{outputRaggedRank:a}=o,l=n.map(m=>r.readSync(m.dataId)),c=n.map(m=>m.shape),u=r.readSync(s.dataId),p=r.readSync(i.dataId),[f,d,h]=N0(l,c,u,s.shape,s.dtype,p,i.shape,a),x=f.map(m=>r.makeTensorInfo([m.length],"int32",m)),g=r.makeTensorInfo(h,s.dtype,d);return x.concat([g])}var Gb={kernelName:lh,backendName:"webgl",kernelFunc:$R};function IR(e){let{inputs:t,backend:r}=e,{starts:o,limits:n,deltas:s}=t,i=r.readSync(o.dataId),a=r.readSync(n.dataId),l=r.readSync(s.dataId),[c,u]=F0(i,o.shape,o.dtype,a,n.shape,l,s.shape),p=r.makeTensorInfo([c.length],"int32",c),f=r.makeTensorInfo([u.length],o.dtype,u);return[p,f]}var Hb={kernelName:ch,backendName:"webgl",kernelFunc:IR};function TR(e){let{inputs:t,backend:r,attrs:o}=e,{shape:n,values:s,defaultValue:i,rowPartitionTensors:a}=t,{rowPartitionTypes:l}=o,c=r.readSync(n.dataId),u=r.readSync(s.dataId),p=r.readSync(i.dataId),f=a.map(g=>r.readSync(g.dataId)),d=a.map(g=>g.shape),[h,x]=D0(c,n.shape,u,s.shape,s.dtype,p,i.shape,f,d,l);return r.makeTensorInfo(h,s.dtype,x)}var qb={kernelName:uh,backendName:"webgl",kernelFunc:TR};var Op=e=>{let{backend:t,attrs:r}=e,{start:o,stop:n,step:s,dtype:i}=r,a=O0(o,n,s,i);return t.makeTensorInfo([a.length],i,a)},Kb={kernelName:ph,backendName:"webgl",kernelFunc:Op};var ER="return 1.0 / x;",_R=L({opSnippet:ER}),Xb={kernelName:fh,backendName:"webgl",kernelFunc:_R};var kR=dt+`
  return (x < 0.0) ? 0.0 : x;
`,AR=`
  vec4 result = x * vec4(greaterThanEqual(x, vec4(0.0)));
  bvec4 isNaN = isnan(x);
...
`,DR=L({opSnippet:NR,packedOpSnippet:FR}),Yb={kernelName:hi,backendName:"webgl",kernelFunc:DR};var vl=class{constructor(t,r,o,n,s){this.variableNames=["A"],this.outputShape=[];let[i,a,l,c]=t;this.outputShape=[i,r,o,c];let u=[n&&r>1?a-1:a,n&&o>1?l-1:l],p=[n&&r>1?r-1:r,n&&o>1?o-1:o],f;s?f="(vec2(yRC) + vec2(0.5)) * effectiveInputOverOutputRatioRC - vec2(0.5)":f="vec2(yRC) * effectiveInputOverOutputRatioRC",this.userCode=`
    ...
    `}};function OR(e){let{inputs:t,backend:r,attrs:o}=e,{images:n}=t,{alignCorners:s,halfPixelCenters:i,size:a}=o,[l,c]=a,u=$().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new Cl(n.shape,l,c,s,i):new vl(n.shape,l,c,s,i);return r.runWebGLProgram(u,[n],"float32")}var Qb={kernelName:mh,backendName:"webgl",kernelFunc:OR};var Sl=class{constructor(t,r,o){this.variableNames=["dy"],this.outputShape=[],this.outputShape=r;let[,n,s]=r,[,i,a]=t,l=[o&&i>1?n-1:n,o&&a>1?s-1:s],c=[o&&i>1?i-1:i,o&&a>1?a-1:a],u=l[0]/c[0],p=l[1]/c[1],f=1/u,d=1/p,h=Math.ceil(f)*2+2,x=Math.ceil(d)*2+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
    ...
    `}};function MR(e){let{inputs:t,backend:r,attrs:o}=e,{images:n}=t,{alignCorners:s,halfPixelCenters:i,size:a}=o,[l,c]=a,u=$().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new Il(n.shape,l,c,s,i):new $l(n.shape,l,c,s,i);return r.runWebGLProgram(u,[n],n.dtype)}var Jb={kernelName:dh,backendName:"webgl",kernelFunc:MR};var Tl=class{constructor(t,r,o){this.variableNames=["dy"],this.outputShape=[],this.outputShape=r;let[,n,s]=r,[,i,a]=t,l=[o&&i>1?n-1:n,o&&a>1?s-1:s],c=[o&&i>1?i-1:i,o&&a>1?a-1:a],u=l[0]/c[0],p=l[1]/c[1],f=1/u,d=1/p,h=Math.ceil(f)*2+2,x=Math.ceil(d)*2+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
    ...
    `}};var rv={kernelName:jh,backendName:"webgl",kernelFunc:({inputs:e,attrs:t,backend:r})=>{let{image:o}=e,{radians:n,fillValue:s,center:i}=t,a=r,l=new kl(o.shape,s),[c,u]=C.getImageCenter(i,o.shape[1],o.shape[2]),p=[[c,u,Math.sin(n),Math.cos(n)]];return a.runWebGLProgram(l,[o],o.dtype,p)}};var UR=`
...
`,VR=L({opSnippet:UR}),ov={kernelName:yh,backendName:"webgl",kernelFunc:VR};var zR="return inversesqrt(x);",WR=L({opSnippet:zR,cpuKernelImpl:P0}),nv={kernelName:mi,backendName:"webgl",kernelFunc:WR};var Er=class{constructor(t,r,o,n,s,i,a=!0,l=!1){this.variableNames=["updates","indices","defaultValue"],this.outputShape=i;let c=G(s.length),u=G(i.length),p="";o===1?p="i":o===2&&(p="i, j");let f=`getIndices(${p})`,d="";n===1?d="i":n===2&&(d="i, coords[1]");let h=`getUpdates(${d})`,x="";l&&(x="coords[0], coords[1]");let g=`getDefaultValue(${x})`,m=r>1?"strides[j]":"strides";this.userCode=`
      ...
      `}};function GR(e){let{inputs:t,backend:r,attrs:o}=e,{indices:n,updates:s}=t,{shape:i}=o,{sliceRank:a,numUpdates:l,sliceSize:c,strides:u,outputSize:p}=C.calculateShapes(s,n,i),f=[p/c,c];if(p===0)return r.makeTensorInfo(i,n.dtype);let d=_({inputs:{x:n},backend:r,attrs:{shape:[l,a]}}),h=_({inputs:{x:s},backend:r,attrs:{shape:[l,c]}}),x=r.makeTensorInfo([],"float32",new Float32Array([0])),g;$().getBool("WEBGL_PACK")?g=new Al(l,a,d.shape.length,h.shape.length,u,f):g=new Er(l,a,d.shape.length,h.shape.length,u,f);let m=r.runWebGLProgram(g,[h,d,x],h.dtype),y=_({inputs:{x:m},backend:r,attrs:{shape:i}});return r.disposeIntermediateTensorInfo(d),r.disposeIntermediateTensorInfo(h),r.disposeIntermediateTensorInfo(m),r.disposeIntermediateTensorInfo(x),y}var sv={kernelName:wh,backendName:"webgl",kernelFunc:GR};var Rl=class{constructor(t,r,o,n){this.variableNames=["sortedSequence","values"],this.customUniforms=[{name:"numInputs",type:"int"}],this.outputShape=[t,o];let s="while (left < right) {",i=`for (int i = 0; i < ${Math.ceil(Math.log2(r+1))}; ++i) { if (left >= right) break;`,a=$().getNumber("WEBGL_VERSION")===2?s:i,l=n==="left"?"<":"<=";this.userCode=`
...
`,YR=`
  ...
  return result;
`,QR=L({opSnippet:jR,packedOpSnippet:YR,cpuKernelImpl:L0}),cv={kernelName:Oo,backendName:"webgl",kernelFunc:QR};var ZR=`
  if (isnan(x)) { return 0.0; }
  return sign(x);
`,JR=L({opSnippet:ZR}),uv={kernelName:Th,backendName:"webgl",kernelFunc:JR};var tN=be+`
  return sin(x);
`,eN=`
  vec4 result = sin(x);
  bvec4 isNaN = isnan(x);
...
`,iN=L({opSnippet:sN}),dv={kernelName:Eh,backendName:"webgl",kernelFunc:iN};var aN=e=>{let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{blockShape:s,paddings:i}=o;w.assert(n.shape.length<=4,()=>"spaceToBatchND for rank > 4 with a WebGL backend not implemented yet");let a=s.reduce((m,y)=>m*y),l=[[0,0]];l.push(...i);for(let m=1+s.length;m<n.shape.length;++m)l.push([0,0]);let c=[],u=Dp({inputs:{x:n},backend:r,attrs:{paddings:l,constantValue:0}}),p=C.getReshaped(u.shape,s,a,!1),f=C.getPermuted(p.length,s.length,!1),d=C.getReshapedPermuted(u.shape,s,a,!1),h=_({inputs:{x:u},backend:r,attrs:{shape:p}}),x=J({inputs:{x:h},backend:r,attrs:{perm:f}}),g=_({inputs:{x},backend:r,attrs:{shape:d}});return c.push(u),c.push(h),c.push(x),c.forEach(m=>r.disposeIntermediateTensorInfo(m)),g},hv={kernelName:_h,backendName:"webgl",kernelFunc:aN};function lN(e){let{inputs:t,backend:r}=e,{indices:o,values:n,denseShape:s,defaultValue:i}=t;if(s.shape.length!==1)throw new Error(`Dense shape must be a vector, saw:
        ...
        ${i.shape}`);let a=r.readSync(o.dataId),l=r.readSync(n.dataId),c=r.readSync(s.dataId),u=r.readSync(i.dataId)[0],[p,f,d,h,x]=U0(a,o.shape,o.dtype,l,n.dtype,c,u);return[r.makeTensorInfo(f,o.dtype,p),r.makeTensorInfo([f[0]],n.dtype,d),r.makeTensorInfo([h.length],"bool",new Uint8Array(h.map(g=>Number(g)))),r.makeTensorInfo([x.length],o.dtype,new Int32Array(x))]}var mv={kernelName:Rh,backendName:"webgl",kernelFunc:lN};function cN(e){let{inputs:t,backend:r}=e,{inputIndices:o,inputShape:n,newShape:s}=t;if(o.shape.length!==2)throw new Error(`Input indices should be a matrix but received shape ${o.shape}`);if(n.shape.length!==1)throw new Error(`Input shape should be a vector but received shape ${n.shape}`);if(s.shape.length!==1)throw new Error(`Target shape should be a vector but received shape ${s.shape}`);let i=Array.from(r.readSync(n.dataId)),a=r.readSync(o.dataId),l=Array.from(r.readSync(s.dataId)),[c,u,p]=V0(a,o.shape,o.dtype,i,l);return[r.makeTensorInfo(u,o.dtype,c),r.makeTensorInfo([p.length],s.dtype,new Int32Array(p))]}var gv={kernelName:Nh,backendName:"webgl",kernelFunc:cN};function uN(e){let{inputs:t,backend:r}=e,{data:o,indices:n,segmentIds:s}=t;if(o.shape.length<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(n.shape.length!==1)throw new Error(`Indices should be a vector but received shape
              ${n.shape}`);if(s.shape.length!==1)throw new Error(`Segment ids should be a vector but received shape
              ${s.shape}`);let i=r.readSync(o.dataId),a=r.readSync(n.dataId),l=r.readSync(s.dataId),[c,u]=da(i,o.shape,o.dtype,a,l,!0);return r.makeTensorInfo(u,o.dtype,c)}var xv={kernelName:Fh,backendName:"webgl",kernelFunc:uN};function pN(e){let{inputs:t,backend:r}=e,{data:o,indices:n,segmentIds:s}=t;if(o.shape.length<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(n.shape.length!==1)throw new Error(`Indices should be a vector but received shape
             ${n.shape}`);if(s.shape.length!==1)throw new Error(`Segment ids should be a vector but received shape
             ${s.shape}`);let i=r.readSync(o.dataId),a=r.readSync(n.dataId),l=r.readSync(s.dataId),[c,u]=da(i,o.shape,o.dtype,a,l);return r.makeTensorInfo(u,o.dtype,c)}var yv={kernelName:Dh,backendName:"webgl",kernelFunc:pN};function fN(e){let{inputs:t,backend:r,attrs:o}=e,{sparseIndices:n,sparseValues:s,defaultValue:i}=t,{outputShape:a}=o,{sliceRank:l,numUpdates:c,sliceSize:u,strides:p,outputSize:f}=C.calculateShapes(s,n,a),d=!1;if(s.dtype==="string"){let m=r.bufferSync(n),y=r.bufferSync(s),v=w.decodeString(r.readSync(i.dataId)[0]),b=M0(m,y,a,f,u,c,l,p,v,d);return r.makeTensorInfo(a,b.dtype,b.values)}let h=new Er(c,l,n.shape.length,s.shape.length,p,[f,1],d),x=r.runWebGLProgram(h,[s,n,i],s.dtype),g=_({inputs:{x},backend:r,attrs:{shape:a}});return r.disposeIntermediateTensorInfo(x),g}var wv={kernelName:Oh,backendName:"webgl",kernelFunc:fN};function dN(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{numOrSizeSplits:s,axis:i}=o,a=w.parseAxisParam(i,n.shape)[0],l=C.prepareSplitSize(n,s,a),c=n.shape.length,u=new Array(c).fill(0),p=n.shape.slice();return l.map(f=>{let d=[...p];d[a]=f;let h=Ae({inputs:{x:n},backend:r,attrs:{begin:u,size:d}});return u[a]+=f,h})}var bv={kernelName:kh,backendName:"webgl",kernelFunc:dN};var vv="return sqrt(x);",hN=L({opSnippet:vv,packedOpSnippet:vv,cpuKernelImpl:z0}),Cv={kernelName:Po,backendName:"webgl",kernelFunc:hN};var mN="return x * x;",gN=L({opSnippet:mN}),Sv={kernelName:Ph,backendName:"webgl",kernelFunc:gN};var $v="return (a - b) * (a - b);",xN=X({opSnippet:$v,packedOpSnippet:$v}),Iv={kernelName:xi,backendName:"webgl",kernelFunc:xN};function yN(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t;if(n.dtype!=="string")throw new Error("Input must be of datatype string");let s=r.readSync(n.dataId),i=C.fromUint8ToStringArray(s),a=W0(i,"string",o);return r.makeTensorInfo(n.shape,"string",a)}var Tv={kernelName:yi,backendName:"webgl",kernelFunc:yN};function wN({inputs:e,attrs:t,backend:r}){let{x:o}=e,n=dt+`
  ...
  `,s=new Et(o.shape,n);return r.runWebGLProgram(s,[o],o.dtype)}var Ev={kernelName:vi,backendName:"webgl",kernelFunc:wN};var Fl=class{constructor(t,r,o){this.variableNames=["x"],this.outputShape=o;let n=o.length,s=G(o.length),i=G(o.length),a="";if(n===1)a="coords * strides + begin";else{let l=0;a=o.map((c,u)=>(l++,o.length===1?`coords * strides[${u}] + begin[${u}]`:`coords[${l-1}] * strides[${u}] + begin[${u}]`)).join(",")}this.userCode=`
    ...
    `}};function bN(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{begin:s,end:i,strides:a,beginMask:l,endMask:c,ellipsisMask:u,newAxisMask:p,shrinkAxisMask:f}=o,{finalShapeSparse:d,finalShape:h,isIdentity:x,sliceDim0:g,isSimpleSlice:m,begin:y,end:v,strides:b}=Wt.sliceInfo(n.shape,s,i,a,l,c,u,p,f),S;if(x)S=_({inputs:{x:n},backend:r,attrs:{shape:h}});else if(g||m){w.assert(n.shape.length>=1,()=>`Input must have rank at least 1, got: ${n.shape.length}`);let T=Wt.computeOutShape(y,v,b),E=Ae({inputs:{x:n},backend:r,attrs:{begin:y,size:T}});S=_({inputs:{x:E},backend:r,attrs:{shape:h}}),r.disposeIntermediateTensorInfo(E)}else if(r.shouldExecuteOnCPU([n])){let E=r.readSync(n.dataId),R=Y(n.shape,n.dtype,E),F=G0(d,R,b,y);S=r.makeTensorInfo(h,n.dtype,F.values)}else{let E=new Fl(y,b,d);S=r.runWebGLProgram(E,[n],n.dtype)}let I=_({inputs:{x:S},backend:r,attrs:{shape:h}});return r.disposeIntermediateTensorInfo(S),I}var _v={kernelName:Mh,backendName:"webgl",kernelFunc:bN};function vN(e){let{inputs:t,backend:r,attrs:o}=e,{separator:n,nGramWidths:s,leftPad:i,rightPad:a,padWidth:l,preserveShortSequences:c}=o,{data:u,dataSplits:p}=t,f=r.readSync(u.dataId),d=r.readSync(p.dataId),[h,x]=H0(f,d,n,s,i,a,l,c);return[r.makeTensorInfo([h.length],"string",h),r.makeTensorInfo(p.shape,"int32",x)]}var kv={kernelName:Lh,backendName:"webgl",kernelFunc:vN};function CN(e){let{inputs:t,backend:r,attrs:o}=e,{skipEmpty:n}=o,{input:s,delimiter:i}=t;if(s.dtype!=="string")throw new Error("Input must be of datatype string");if(s.shape.length!==1)throw new Error(`Input must be a vector, got shape: ${s.shape}`);if(i.shape.length!==0)throw new Error(`Delimiter must be a scalar, got shape: ${i.shape}`);let a=r.readSync(s.dataId),l=r.readSync(i.dataId)[0],[c,u,p]=q0(a,l,n),f=u.length;return[r.makeTensorInfo([f,2],"int32",c),r.makeTensorInfo([f],"string",u),r.makeTensorInfo([2],"int32",new Int32Array(p))]}var Av={kernelName:Bh,backendName:"webgl",kernelFunc:CN};function SN(e){let{inputs:t,backend:r,attrs:o}=e,{numBuckets:n}=o,{input:s}=t;if(s.dtype!=="string")throw new Error("Input must be of datatype string");if(n<=0)throw new Error("Number of buckets must be at least 1");let i=r.readSync(s.dataId),a=K0(i,n);return r.makeTensorInfo(s.shape,"int32",a)}var Rv={kernelName:Uh,backendName:"webgl",kernelFunc:SN};var $N="return tan(x);",IN=L({opSnippet:$N}),Nv={kernelName:Vh,backendName:"webgl",kernelFunc:IN};var TN=`
  float e2x = exp(-2.0 * abs(x));
  return sign(x) * (1.0 - e2x) / (1.0 + e2x);
`,EN=L({opSnippet:TN}),Fv={kernelName:zh,backendName:"webgl",kernelFunc:EN};function _N(e){let{inputs:t,backend:r,attrs:o}=e,{tensor:n,indices:s,updates:i}=t,{}=o,{sliceRank:a,numUpdates:l,sliceSize:c,strides:u,outputSize:p}=C.calculateShapes(i,s,n.shape),f=[p/c,c];if(p===0)return r.makeTensorInfo(n.shape,s.dtype);let d=_({inputs:{x:s},backend:r,attrs:{shape:[l,a]}}),h=_({inputs:{x:i},backend:r,attrs:{shape:[l,c]}}),x=_({inputs:{x:n},backend:r,attrs:{shape:f}}),g=new Er(l,a,d.shape.length,h.shape.length,u,f,!1,!0),m=r.runWebGLProgram(g,[h,d,x],x.dtype),y=_({inputs:{x:m},backend:r,attrs:{shape:n.shape}});return r.disposeIntermediateTensorInfo(d),r.disposeIntermediateTensorInfo(h),r.disposeIntermediateTensorInfo(x),r.disposeIntermediateTensorInfo(m),y}var Dv={kernelName:bh,backendName:"webgl",kernelFunc:_N};var Dl=class{constructor(t,r){this.variableNames=["A"];let o=new Array(t.length);for(let i=0;i<o.length;i++)o[i]=t[i]*r[i];this.outputShape=o,this.rank=o.length;let n=G(this.rank),s=kN(t);this.userCode=`
      void main() {
        ${n} resRC = getOutputCoords();
        setOutput(getA(${s}));
      }
    `}};function kN(e){let t=e.length;if(t>5)throw Error(`Tile for rank ${t} is not yet supported`);if(t===1)return`imod(resRC, ${e[0]})`;let r=["resRC.x","resRC.y","resRC.z","resRC.w","resRC.u"],o=[];for(let n=0;n<e.length;n++)o.push(`imod(${r[n]}, ${e[n]})`);return o.join()}function Pp(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{reps:s}=o;if(n.dtype==="string"||n.shape.length>5){let l=r.readSync(n.dataId),c=n.dtype==="string"?l.map(f=>w.decodeString(f)):l,u=Y(n.shape,n.dtype,c),p=j0(u,s);return r.makeTensorInfo(p.shape,p.dtype,p.values)}let i=new Dl(n.shape,s);return r.runWebGLProgram(i,[n],n.dtype)}var Ov={kernelName:wi,backendName:"webgl",kernelFunc:Pp};var Ol=class{constructor(t){this.variableNames=["x","indices"],this.customUniforms=[{name:"n",type:"int"},{name:"firstPass",type:"int"},{name:"negativeInf",type:"float"},{name:"dir",type:"int"},{name:"inc",type:"int"}],this.outputShape=t,this.userCode=`
       void main() {
         ivec2 coords = getOutputCoords();
         int batch = coords[0];
    ...
    void main() {
     ...
     `}};function lo(e,t){t!==null&&e.disposeIntermediateTensorInfo(t)}function Pv(e){let t=1;for(;t<e;)t*=2;return t}function AN(e){let{inputs:t,backend:r,attrs:o}=e,{x:n}=t,{k:s,sorted:i}=o,a=$().getNumber("TOPK_LAST_DIM_CPU_HANDOFF_SIZE_THRESHOLD"),l=$().getNumber("TOPK_K_CPU_HANDOFF_THRESHOLD"),c=n.shape,u=c[c.length-1];if(r.shouldExecuteOnCPU([n])||u<a||s>l){let F=r.readSync(n.dataId),[U,z]=Y0(F,c,n.dtype,s,i);return[r.makeTensorInfo(U.shape,U.dtype,U.values),r.makeTensorInfo(z.shape,z.dtype,z.values)]}if(s===0)return c[c.length-1]=0,[r.makeTensorInfo(c,n.dtype,[]),r.makeTensorInfo(c,"int32",[])];if(u===1)return[n,sr({attrs:{shape:c,dtype:"int32",value:0},backend:r})];let p=r.texData.get(n.dataId),f=p!==null&&p.isPacked,d=f?r.unpackTensor(n):n,x=w.sizeFromShape(c)/u,g=_({inputs:{x:d},attrs:{shape:[x,u]},backend:r});f&&lo(r,d);let m=Pv(s),y=Pv(u),v=null,b=()=>v===null?[g,g]:[g,v],S=(F,U,z)=>{let ft=b(),tt=new Ol(z),gt=[[u],[v===null?1:0],[Number.NEGATIVE_INFINITY],[F],[U]],xt=v;v=r.runWebGLProgram(tt,ft,"int32",gt),lo(r,xt)};for(let F=1;F<m;F*=2){let U=F*2;for(let z=F;z>=1;z/=2)S(U,z,[x,y])}for(let F=y;F>m;F/=2){let U=b(),z=new Pl([x,F/2]),tt=[[u],[v===null?1:0],[m]],mt=v;v=r.runWebGLProgram(z,U,"int32",tt),lo(r,mt);let gt=m/2,xt=gt*2;for(let yt=gt;yt>=1;yt/=2)S(xt,yt,v.shape)}let I=v;v=Ae({inputs:{x:v},backend:r,attrs:{begin:0,size:[x,s]}}),lo(r,I);let T=kp({inputs:{x:g,indices:v},backend:r,attrs:{axis:1,batchDims:1}});lo(r,g);let E=c.slice(0,-1);E.push(s),I=v,v=_({inputs:{x:v},attrs:{shape:E},backend:r}),lo(r,I);let R=T;return T=_({inputs:{x:T},attrs:{shape:E},backend:r}),lo(r,R),[T,v]}var Mv={kernelName:Wh,backendName:"webgl",kernelFunc:AN};var Ml=class{constructor(t,r,o,n,s,i){this.variableNames=["Image","Transforms"],this.outputShape=i;let a=o==="nearest"?1:2,l;switch(n){case"constant":l=1;break;case"reflect":l=2;break;case"wrap":l=3;break;case"nearest":l=4;break;default:l=1;break}this.userCode=`
        ...
        `}};function RN(e){let{inputs:t,backend:r,attrs:o}=e,{image:n,transforms:s}=t,{interpolation:i,fillMode:a,fillValue:l,outputShape:c}=o,[u,p,f,d]=n.shape,[h,x]=c??[p,f],g=[u,h,x,d],m=new Ml(p,f,i,a,l,g);return r.runWebGLProgram(m,[n,s],"float32")}var Lv={kernelName:Gh,backendName:"webgl",kernelFunc:RN};function NN(e){let{inputs:t,attrs:r,backend:o}=e,{axis:n}=r,{x:s}=t;We(s,"unique"),console.warn("WARNING: ","UI might be locked temporarily as data is being downloaded");let i=o.readSync(s.dataId),{outputValues:a,outputShape:l,indices:c}=Q0(i,n,s.shape,s.dtype);return[o.makeTensorInfo(l,s.dtype,a),o.makeTensorInfo([c.length],"int32",c)]}var Bv={kernelName:Hh,backendName:"webgl",kernelFunc:NN};function FN(e){let{inputs:t,backend:r,attrs:o}=e,{value:n}=t,{axis:s}=o;s<0&&(s+=n.shape.length);let i=n,a=i.shape.length,l=n.shape[s],c=new Array(a-1),u=0;for(let x=0;x<a;x++)x!==s&&(c[u++]=i.shape[x]);let p=[],f=new Array(a).fill(0),d=i.shape.slice();d[s]=1;let h=new Array(l);for(let x=0;x<h.length;x++){f[s]=x;let g=Ae({inputs:{x:i},backend:r,attrs:{begin:f,size:d}}),m=_({inputs:{x:g},backend:r,attrs:{shape:c}});h[x]=m,p.push(g)}return p.forEach(x=>r.disposeIntermediateTensorInfo(x)),h}var Uv={kernelName:qh,backendName:"webgl",kernelFunc:FN};var Ll=class{constructor(t,r){this.variableNames=["x","segmentIds"];let o=t.windowSize,n=t.batchSize,s=t.inSize,i=t.numSegments,a=i*Math.ceil(s/o);this.outputShape=[n,a];let l="0.0",c="sumValue",u=Math.floor(o/4)*4,p=o%4,f=`
...
*/
//# sourceMappingURL=index-2KKNPPCU.js.map
